 ...
 */
package com.lab.dxy.bracelet.core.cache;
...
public class ACache {
    ...
    private static final String DEFAULT_FILE_NAME = "Bracelet";
    private static Map<String, ACache> mInstanceMap = new HashMap<>();
    private ACacheManager mCache;

    public static ACache get(Context ctx) {
        return get(ctx, DEFAULT_FILE_NAME);
    }
    ...
    public static ACache get(Context ctx, long max_zise, int max_count) {
        File f = new File(ctx.getExternalCacheDir(), DEFAULT_FILE_NAME);
     ...
     * @return Serializable 数据
     */
    public Object getAs2Object(String key) {
        byte[] data = getAsBinary(key);
        if (data != null) {
            ByteArrayInputStream bais = null;
            ObjectInputStream ois = null;

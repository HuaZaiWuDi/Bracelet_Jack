...
public class RxTextUtils {
    ...
    public static void setTextView(@NonNull Context context, @NonNull TextView textView, int text, @ColorInt int color) {
        RxTextUtils.getBuilder("")
                .append(text / 60 + "").setForegroundColor(color)
                .append(context.getString(R.string.hour)).setProportion(0.5f).setForegroundColor(Color.parseColor("#BAB7BF"))
                .append(text % 60 + "").setForegroundColor(color)
                .append(context.getString(R.string.min)).setProportion(0.5f).setForegroundColor(Color.parseColor("#BAB7BF"))
                .into(textView);
    }


    public static void setHeartRate(@NonNull Context context, @NonNull TextView textView, int text, @ColorInt int color) {
        RxTextUtils.getBuilder("")
                .append(text + "").setBold().setProportion(2f).setForegroundColor(color)
                .append(context.getString(R.string.heartRateUnit)).setForegroundColor(color)
                .into(textView);
    }

    public static void setHeartRate(@NonNull TextView textView, int text) {
        RxTextUtils.getBuilder("")
                .append(text + "").setBold().setProportion(1.2f).setForegroundColor(Color.parseColor("#FF726B"))
                .append("bpm").setForegroundColor(Color.parseColor("#BAB7BF"))
                .into(textView);
    }

...
public class RxLogUtils {
    ...
    private static Boolean LOG_TO_FILE = BuildConfig.LOG_DEBUG; // 日志写入文件开关
    ...
    private static String LOG_FILE_PATH = Environment.getExternalStorageDirectory() + Contents.DOWNLOAD_FOLDER + "/RxLog/"; // 日志文件保存路径
...
//                log2File(String.valueOf(level), tag, msg);
    ...
    private synchronized static void log2File(String mylogtype, String tag, String text) {
        ...
        String dateLogContent = LOG_FORMAT.format(nowtime) + ":" + mylogtype + ":" + text; // 日志输出格式
     ...
     * 删除日志文件
     */
    public static void delAllFile() {// 删除日志文件
